...
const Features = () => {
  ...
  return (
    <div id="features" className="flex flex-col items-center my-10 scroll-mt-12">
        ...
        <Title title='Build your resume' description='Our streamlined process helps you create a professional resume in minutes with intelligent AI-poered tools and features.' />
