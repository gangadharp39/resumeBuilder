  ...
  return (
    <div className='space-y-4'>
      ...
      <div className='mt-6'>
        ...
        <p className='text-xs text-gray-500 max-w-4/5 mx-auto text-center'> Tip: Keep it concise (3-4 sentences) and focus on your most relavant achievements and skills. </p>
      </div>
    </div>
  )
}
