              ...
              >
                ...
                >
                  <TrashIcon
                    ...
                    className="size-7 p-1.5 hover:bg-white/50 rounded text-slate-700 transaction-colors"
                  />
                  <PencilIcon
                    onClick={() => {
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  accept=".pdf"
                  hidden
                  onChange={(e) => setResume(e.target.fiels[0])}
                />
              </div>
              <button
                disabled={isLoading}
